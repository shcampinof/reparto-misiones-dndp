...
| BF-15 | Plazos de 25, 40 o 45 días, carga máxima de seis, máximo de cinco ampliaciones y semáforos 15/6/5 aparecen de manera contradictoria. | contradicción documental | No se codifican como valores funcionales. La política de plazo permanece nula y vinculada a `DEC-PLZ-001`; el reparto usa carga relativa sin umbral fijo. |
| BF-16 | Solicitud, persona vinculada, ítem, asignación, producto, ampliación, reasignación y transferencia del defensor tienen ciclos e indicadores distintos. | confirmado | Solicitud, personas, ítems, asignaciones, productos y operaciones se exponen por separado. Ampliación, reasignación y transferencia tienen contrato bloqueado y siguen siendo obligatorias antes del mapeo Oracle. |
